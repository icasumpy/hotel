            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form action="{{ url('add_booking', $room->id) }}" method="POST">
                        ...
                        <div>
                            <label>Name</label>
                            <input type="text" name="name" value="{{ Auth::id() ? Auth::user()->name : '' }}">
                        </div>
                        <div>
                            <label>Email</label>
                            <input type="email" name="email" value="{{ Auth::id() ? Auth::user()->email : '' }}">
                        </div>
                        <div>
                            <label>Phone</label>
                            <input type="number" name="phone" value="{{ Auth::id() ? Auth::user()->phone : '' }}">
                        </div>
                        <div>
